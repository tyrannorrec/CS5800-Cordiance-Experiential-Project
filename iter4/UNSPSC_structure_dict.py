...
class UNSPSC_Dict:
    ...
    def build(self):
        ...
        # Extracts all text elements for item in UNSPSC file and outputs a list of words representing that item
        def getStringData(i):
        ...
        # For each item in UNSPSC file, add item to dictionary where key = commodity ID and value = list of words for item
